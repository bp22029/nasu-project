...
const TYPE_SEED: { code: string; image: string; animal: string; name: string; tagline: string; description: string }[] = [
  ...
  { code: "phnx", image: "/diagnosis-types/05_phnx_sheep.png",      animal: "ヒツジ",     name: "しずか湯めぐり人", tagline: "計画×癒し×内向×体験", description: "予定は決めつつ、静かな温泉や森カフェでゆっくり“ととのう”のが理想。落ち着いた時間を味わうタイプ。" },
  ...
  { code: "isnx", image: "/diagnosis-types/09_isnx_redpanda.png",   animal: "レッサーパンダ", name: "きまぐれ探検家", tagline: "即興×刺激×内向×体験", description: "その時の気分で刺激的な体験へ飛び込むあなた。ひとりで気ままに、心の動くままに冒険します。" },
  ...
  { code: "ihex", image: "/diagnosis-types/15_ihex_donkey.png",     animal: "ロバ",       name: "ゆる旅なかまナビゲーター", tagline: "即興×癒し×外向×体験", description: "計画より流れにまかせ、人とのんびり癒しの時間を。寄り道しながら旅を楽しむおおらかなタイプ。" },
